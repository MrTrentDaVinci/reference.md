...
This is your canonical, LLM-grounded reference for projects, tracking, templates, and personal info. Use raw links for strict grounding in prompts — focus on one or a few at a time to stay token-efficient.

## About Me Files
These provide personal grounding for tailoring resumes, applications, or outreach.

- [Contact Info](https://raw.githubusercontent.com/MrTrentDaVinci/reference/main/contact.md)  
  Basic professional contact details and availability.  
  Public file for easy sharing; always confirm before using in outputs.

- [Professional Profile](https://raw.githubusercontent.com/MrTrentDaVinci/reference/main/professional_profile.md)  
  Detailed overview of experience, skills, and career narrative for customizing resumes and job materials.  
  Living document; use for LLM-guided tailoring to specific roles/companies.
...
## Other Core Files
- [Company & Role Tracking](https://raw.githubusercontent.com/MrTrentDaVinci/reference/main/tracking.md) – Tracks target companies, roles, fit reasons, and strategies for LLM-assisted applications.
- [Project Templates](https://raw.githubusercontent.com/MrTrentDaVinci/reference/main/template.md) – Structures for generating resumes, posts, profiles; enforces grounded outputs.
